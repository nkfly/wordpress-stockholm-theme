                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <select name="import_example" id="import_example" class="form-control qodef-form-element">
                                                ...
                                                <option value="stockholmnew21">New Demo 21 - Olaf</option>
                                                <option value="stockholmnew22">New Demo 22 - Freya</option>
                                                <option value="stockholmnew23">New Demo 22 - Gunnar</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-3">
