...
if(isset($qode_options['button_padding']) && $qode_options['button_padding'] !== '') {
	$default_btn_styles .= 'padding-left: '.$qode_options['button_padding'].'px;';
	$default_btn_styles .= 'padding-right: '.$qode_options['button_padding'].'px;';
}
...
if(isset($qode_options['button_underlined_border_color']) && $qode_options['button_underlined_border_color'] !== '') {
	$underlined_btn_styles .= 'border-bottom-color: '.$qode_options['button_underlined_border_color'].';';
}

if(isset($qode_options['button_underlined_text_color']) && $qode_options['button_underlined_text_color'] !== '') {
	$underlined_btn_styles .= 'color: '.$qode_options['button_underlined_text_color'].';';
}
...
if(isset($qode_options['button_underlined_text_color_hover']) && $qode_options['button_underlined_text_color_hover'] !== '') {
	$underlined_btn_hover_styles .= 'color: '.$qode_options['button_underlined_text_color_hover'].' !important;';
}
...
if(isset($qode_options['button_underlined_border_color_hover']) && $qode_options['button_underlined_border_color_hover'] !== '') { ?>
	.qbutton.underlined .qode-underlined-button-span {
	background-color:<?php echo esc_attr($qode_options['button_underlined_border_color_hover']); ?>;
	}
...
if(isset($qode_options['back_to_top_border_width']) && !empty($qode_options['back_to_top_border_width'])) {
	$q_back_to_top_styles .= 'border-width: '.$qode_options['back_to_top_border_width'].'px;';
}

if(isset($qode_options['back_to_top_width']) && !empty($qode_options['back_to_top_width'])) {
	$q_back_to_top_styles .= 'width: '.$qode_options['back_to_top_width'].'px;';
}

if(isset($qode_options['back_to_top_height']) && !empty($qode_options['back_to_top_height'])) {
	$q_back_to_top_styles .= 'height: '.$qode_options['back_to_top_height'].'px;';

	if(isset($qode_options['back_to_top_border_width']) && !empty($qode_options['back_to_top_border_width'])) {
		$q_back_to_top_styles .= 'line-height: '.($qode_options['back_to_top_height'] - 2*$qode_options['back_to_top_border_width']).'px;';
	} else {
		$q_back_to_top_styles .= 'line-height: '.$qode_options['back_to_top_height'].'px;';
	}
...
if(isset($qode_options['navigation_border_width']) && !empty($qode_options['navigation_border_width'])) {
	$q_navigation_styles .= 'border-width: '.$qode_options['navigation_border_width'].'px;';
}

if(isset($qode_options['navigation_width']) && !empty($qode_options['navigation_width'])) {
	$q_navigation_styles .= 'width: '.$qode_options['navigation_width'].'px;';
}
if(isset($qode_options['navigation_height']) && !empty($qode_options['navigation_height'])) {
	$q_navigation_styles .= 'height: '.$qode_options['navigation_height'].'px;';
	$q_navigation_styles .= 'line-height: '.$qode_options['navigation_height'].'px;';
	if(isset($qode_options['navigation_border_width']) && !empty($qode_options['navigation_border_width'])) {
		$q_navigation_styles .= 'margin-top: -'.($qode_options['navigation_height']/2 + $qode_options['navigation_border_width']) . 'px;';
	} else {
		$q_navigation_styles .= 'margin-top: -'.$qode_options['navigation_height']/2 . 'px;';
	}
...
if(isset($qode_options['tags_border_hover_color']) && $qode_options['tags_border_hover_color'] !== '') {
	$tags_hover_styles[] = 'border-color: '.$qode_options['tags_border_hover_color'];
}
...
<?php if (qode_options()->getOptionValue('tab_bottom_border_color') !== '') {?>
    .q_tabs .tabs-nav li a{
    ...
    .q_tabs .tabs-nav li a:hover:after{
        ...
        left: 0;
        z-index: 10;
        background-color: <?php echo esc_attr(qode_options()->getOptionValue('tab_bottom_border_color'))?>;
    }
...
<?php } ?>
<?php if (!empty($qode_options['footer_left_padding']) || !empty($qode_options['footer_right_padding'])) { ?>
	.footer_top.footer_top_full {
	<?php if (!empty($qode_options['footer_left_padding'])){ ?>padding-left: <?php echo esc_attr($qode_options['footer_left_padding']); echo $px_string = (qode_string_ends_with($qode_options['footer_left_padding'], 'px') || qode_string_ends_with($qode_options['footer_left_padding'], '%')) ? '' : 'px'; ?>; <?php } ?>
	<?php if (!empty($qode_options['footer_right_padding'])){ ?>padding-right: <?php echo esc_attr($qode_options['footer_right_padding']); echo $px_string = (qode_string_ends_with($qode_options['footer_right_padding'], 'px') || qode_string_ends_with($qode_options['footer_right_padding'], '%')) ? '' : 'px';  ?>; <?php } ?>
	}
<?php } ?>
...
<?php } ?>
<?php if(isset($qode_options['sidearea_close_icon_size']) && !empty($qode_options['sidearea_close_icon_size'])){ ?>
	.side_menu a.close_side_menu_fold {
		width: <?php echo esc_attr($qode_options['sidearea_close_icon_size']);  ?>px;
		height: <?php echo esc_attr($qode_options['sidearea_close_icon_size']);  ?>px;
		line-height: <?php echo esc_attr($qode_options['sidearea_close_icon_size']);  ?>px;
	}
...
if(isset($qode_options['woo_products_price_filter_arrows_color']) && !empty($qode_options['woo_products_price_filter_arrows_color'])) {
	$woo_products_price_filter_arrows_style[] = 'background-color: '. $qode_options['woo_products_price_filter_arrows_color'];
}

if(isset($qode_options['woo_products_price_filter_arrows_height']) && !empty($qode_options['woo_products_price_filter_arrows_height'])) {
	$woo_products_price_filter_arrows_style[] = 'height: '. $qode_options['woo_products_price_filter_arrows_height'] . 'px';
	$woo_products_price_filter_arrows_style[] = 'width: '. $qode_options['woo_products_price_filter_arrows_height'] . 'px';

	if(isset($qode_options['woo_products_price_filter_slider_height']) && !empty($qode_options['woo_products_price_filter_slider_height'])) {
		$woo_products_price_filter_arrows_style[] = 'top: -'. (($qode_options['woo_products_price_filter_arrows_height'] - $qode_options['woo_products_price_filter_slider_height']) / 2) . 'px';
	}
}

if(isset($qode_options['woo_products_price_filter_arrows_border_radius']) && !empty($qode_options['woo_products_price_filter_arrows_border_radius'])) {
	$woo_products_price_filter_arrows_style[] = 'border-radius: '. $qode_options['woo_products_price_filter_arrows_border_radius'] . 'px';
}
...
<?php } ?>
<?php if(isset($qode_options['woo_products_price_filter_slider_height']) && !empty($qode_options['woo_products_price_filter_slider_height'])) { ?>
	.woocommerce .widget_price_filter .ui-slider-horizontal,
	.woocommerce-page .widget_price_filter .ui-slider-horizontal {
		height: <?php echo esc_attr($qode_options['woo_products_price_filter_slider_height']); ?>px;
	}
<?php } ?>
<?php
...
$woo_products_single_qunatity_width = qode_options()->getOptionValue('woo_products_single_qunatity_width');
...
if (count($woo_products_single_qunatity_style)){
	echo qode_dynamic_css('.woocommerce div.product .cart .quantity',array('height' => $woo_products_single_qunatity_width.'px', 'line-height' => $woo_products_single_qunatity_width.'px'));

	echo qode_dynamic_css('.woocommerce .product .quantity .minus,
...
//Contact Form 7 Custom Styles - start
	...
	if (isset($qode_options['cf7_custom_style_1_element_border_width']) && $qode_options['cf7_custom_style_1_element_border_width'] !== '') {
		$cf7_custom_style_1_animation_line_style .= 'height: ' . esc_attr($qode_options['cf7_custom_style_1_element_border_width']) . 'px;';
	...
	if (isset($qode_options['cf7_custom_style_1_element_focus_border_color']) && $qode_options['cf7_custom_style_1_element_focus_border_color'] !== '') {
		if (isset($qode_options['cf7_custom_style_1_focus_border_transparency']) && $qode_options['cf7_custom_style_1_focus_border_transparency'] !== '') {
			...
			$cf7_custom_style_1_animation_line_focus_style .= 'border-color: rgba(' . esc_attr($cf7_custom_style_1_element_focus_border_color[0]) . ',' . esc_attr($cf7_custom_style_1_element_focus_border_color[1]) . ',' . esc_attr($cf7_custom_style_1_element_focus_border_color[2]) . ',' . esc_attr($qode_options['cf7_custom_style_1_focus_border_transparency']) . ');';
			...
			$cf7_custom_style_1_animation_line_focus_style .= 'border-color: ' . esc_attr($qode_options['cf7_custom_style_1_element_focus_border_color']) . ';';
		}
	}
