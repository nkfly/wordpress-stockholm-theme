...
if(!function_exists('qode_woocommerce_options_map')) {
	...
	function qode_woocommerce_options_map()
	{
		...
		qode_framework()->qodeOptions->addAdminPage("woocommerce", $woocommercePage);
...
// General
		...
		$woo_products_list_add_to_cart_text_transform = new QodeField("selectblanksimple", "woo_products_list_add_to_cart_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_list_add_to_cart_font_style = new QodeField("selectblanksimple", "woo_products_list_add_to_cart_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_list_add_to_cart_font_style", $woo_products_list_add_to_cart_font_style);

		$woo_products_list_add_to_cart_font_weight = new QodeField("selectblanksimple", "woo_products_list_add_to_cart_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
...
//Product list styles
		...
		$woo_products_category_text_transform = new QodeField("selectblanksimple", "woo_products_category_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_category_font_style = new QodeField("selectblanksimple", "woo_products_category_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_category_font_style", $woo_products_category_font_style);

		$woo_products_category_font_weight = new QodeField("selectblanksimple", "woo_products_category_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_products_title_text_transform = new QodeField("selectblanksimple", "woo_products_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_standard_category_text_transform = new QodeField("selectblanksimple", "woo_products_standard_category_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_standard_category_font_style = new QodeField("selectblanksimple", "woo_products_standard_category_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_standard_category_font_style", $woo_products_standard_category_font_style);

		$woo_products_standard_category_font_weight = new QodeField("selectblanksimple", "woo_products_standard_category_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_products_standard_title_text_transform = new QodeField("selectblanksimple", "woo_products_standard_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_standard_title_font_style = new QodeField("selectblanksimple", "woo_products_standard_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_standard_title_font_style", $woo_products_standard_title_font_style);

		$woo_products_standard_title_font_weight = new QodeField("selectblanksimple", "woo_products_standard_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_products_standard_price_text_transform = new QodeField("selectblanksimple", "woo_products_standard_price_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_standard_price_font_style = new QodeField("selectblanksimple", "woo_products_standard_price_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_standard_price_font_style", $woo_products_standard_price_font_style);

		$woo_products_standard_price_font_weight = new QodeField("selectblanksimple", "woo_products_standard_price_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_products_standard_list_add_to_cart_text_transform = new QodeField("selectblanksimple", "woo_products_standard_list_add_to_cart_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_standard_list_add_to_cart_font_style = new QodeField("selectblanksimple", "woo_products_standard_list_add_to_cart_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_standard_list_add_to_cart_font_style", $woo_products_standard_list_add_to_cart_font_style);

		$woo_products_standard_list_add_to_cart_font_weight = new QodeField("selectblanksimple", "woo_products_standard_list_add_to_cart_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
...
//Product title
		...
		$woo_products_simple_title_text_transform = new QodeField("selectblanksimple", "woo_products_simple_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_simple_title_font_style = new QodeField("selectblanksimple", "woo_products_simple_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_simple_title_font_style", $woo_products_simple_title_font_style);

		$woo_products_simple_title_font_weight = new QodeField("selectblanksimple", "woo_products_simple_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
...
//Product price
		...
		$woo_products_simple_price_text_transform = new QodeField("selectblanksimple", "woo_products_simple_price_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_simple_price_font_style = new QodeField("selectblanksimple", "woo_products_simple_price_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_simple_price_font_style", $woo_products_simple_price_font_style);

		$woo_products_simple_price_font_weight = new QodeField("selectblanksimple", "woo_products_simple_price_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_products_sorting_result_text_transform = new QodeField("selectblanksimple", "woo_products_sorting_result_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_sorting_result_font_style = new QodeField("selectblanksimple", "woo_products_sorting_result_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_sorting_result_font_style", $woo_products_sorting_result_font_style);

		$woo_products_sorting_result_font_weight = new QodeField("selectblanksimple", "woo_products_sorting_result_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$row1->addChild("woo_products_price_filter_background_color", $woo_products_price_filter_background_color);
		...
		$row1->addChild("woo_products_price_filter_background_active_color", $woo_products_price_filter_background_active_color);
		...
		$row1->addChild("woo_products_price_filter_arrows_color", $woo_products_price_filter_arrows_color);

		$woo_products_price_filter_slider_height = new QodeField("textsimple", "woo_products_price_filter_slider_height", "", "Slider Height(px)", "This is some description");
		$row1->addChild("woo_products_price_filter_slider_height", $woo_products_price_filter_slider_height);

		$row2 = new QodeRow(true);
		$group9->addChild("row2", $row2);

		$woo_products_price_filter_arrows_height = new QodeField("textsimple", "woo_products_price_filter_arrows_height", "", "Arrows Height(px)", "This is some description");
		$row2->addChild("woo_products_price_filter_arrows_height", $woo_products_price_filter_arrows_height);

		$woo_products_price_filter_arrows_border_radius = new QodeField("textsimple", "woo_products_price_filter_arrows_border_radius", "", "Arrows Border Radius(px)", "This is some description");
		$row2->addChild("woo_products_price_filter_arrows_border_radius", $woo_products_price_filter_arrows_border_radius);
...
//Product single styles
		...
		$group0 = new QodeGroup("Product Thumbnails", "Define Product Thumbnails Style");
		$panel2->addChild("group0", $group0);

		$row0 = new QodeRow();
		$group0->addChild("row0", $row0);

		$woo_product_single_thumb_number = new QodeField("selectsimple", "woo_product_single_thumb_number", "4", "Number of thumbnails", "This is some description", array(
			"4" => "4",
			"3" => "3",
		));
		$row0->addChild("woo_product_single_thumb_number", $woo_product_single_thumb_number);
		...
		$woo_product_single_title_text_transform = new QodeField("selectblanksimple", "woo_product_single_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_product_single_meta_title_text_transform = new QodeField("selectblanksimple", "woo_product_single_meta_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_product_single_meta_title_font_style = new QodeField("selectblanksimple", "woo_product_single_meta_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_product_single_meta_title_font_style", $woo_product_single_meta_title_font_style);

		$woo_product_single_meta_title_font_weight = new QodeField("selectblanksimple", "woo_product_single_meta_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_product_single_meta_info_text_transform = new QodeField("selectblanksimple", "woo_product_single_meta_info_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_product_single_meta_info_font_style = new QodeField("selectblanksimple", "woo_product_single_meta_info_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_product_single_meta_info_font_style", $woo_product_single_meta_info_font_style);

		$woo_product_single_meta_info_font_weight = new QodeField("selectblanksimple", "woo_product_single_meta_info_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_product_single_related_text_transform = new QodeField("selectblanksimple", "woo_product_single_related_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_product_single_related_font_style = new QodeField("selectblanksimple", "woo_product_single_related_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_product_single_related_font_style", $woo_product_single_related_font_style);

		$woo_product_single_related_font_weight = new QodeField("selectblanksimple", "woo_product_single_related_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$group51 = new QodeGroup("Quantity Button Style", "Define Quantity Button Style");
		$panel2->addChild("group51", $group51);

		$woo_products_single_qunatity_width = new QodeField("textsimple", "woo_products_single_qunatity_width", "", "Width/Height (px)", "");
		$group51->addChild("woo_products_single_qunatity_width", $woo_products_single_qunatity_width);
		...
		$woo_products_single_add_to_cart_text_transform = new QodeField("selectblanksimple", "woo_products_single_add_to_cart_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_products_single_add_to_cart_font_style = new QodeField("selectblanksimple", "woo_products_single_add_to_cart_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_products_single_add_to_cart_font_style", $woo_products_single_add_to_cart_font_style);

		$woo_products_single_add_to_cart_font_weight = new QodeField("selectblanksimple", "woo_products_single_add_to_cart_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
...
//Shop category showcase styles
		...
		$woo_shop_category_showcase_category_title_text_transform = new QodeField("selectblanksimple", "woo_shop_category_showcase_category_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_shop_category_showcase_category_title_font_style = new QodeField("selectblanksimple", "woo_shop_category_showcase_category_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_shop_category_showcase_category_title_font_style", $woo_shop_category_showcase_category_title_font_style);

		$woo_shop_category_showcase_category_title_font_weight = new QodeField("selectblanksimple", "woo_shop_category_showcase_category_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_shop_category_showcase_product_title_text_transform = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_title_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_shop_category_showcase_product_title_font_style = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_title_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_shop_category_showcase_product_title_font_style", $woo_shop_category_showcase_product_title_font_style);

		$woo_shop_category_showcase_product_title_font_weight = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_title_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woo_shop_category_showcase_product_price_text_transform = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_price_text_transform", "", "Text Transform", "This is some description", qode_get_text_transform_array());
		...
		$woo_shop_category_showcase_product_price_font_style = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_price_font_style", "", "Font Style", "This is some description", qode_get_font_style_array());
		$row2->addChild("woo_shop_category_showcase_product_price_font_style", $woo_shop_category_showcase_product_price_font_style);

		$woo_shop_category_showcase_product_price_font_weight = new QodeField("selectblanksimple", "woo_shop_category_showcase_product_price_font_weight", "", "Font Weight", "This is some description", qode_get_font_weight_array());
		...
		$woocommercePage->addChild('panel_dropdown_cart', $panel_dropdown_cart);

		$woo_dropdown_cart_icon = new QodeField('select', 'woo_dropdown_cart_icon', '', 'Cart Icon Font', 'Choose icon font for dropdown cart icon', array(
			'' => 'Font Awesome Icon',
			'font-elegant' => 'Font Elegant Icon',
			'font-linear' => 'Linear Icon'
		));
		$panel_dropdown_cart->addChild('woo_dropdown_cart_icon', $woo_dropdown_cart_icon);

	}
	add_action('qode_options_map','qode_woocommerce_options_map',190);
}