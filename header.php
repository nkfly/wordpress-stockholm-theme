...
})(window,document,'script','dataLayer','GTM-T277HKS');</script>
...
$header_transparency = '';
if($per_page_header_transparency !== false && $per_page_header_transparency !== '') {
...
global $qode_toolbar;
?>
<?php do_action('qode_before_page_header'); ?>
<?php if(!$enable_vertical_menu){ ?>
